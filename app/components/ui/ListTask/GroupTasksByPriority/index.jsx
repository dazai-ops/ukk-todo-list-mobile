...
const ShowGroupTasksByPriority = ({filteredTasks, showModalDetail, showModalStatus, showModalPriority, showModalEditTask}) => {
...
export default ShowGroupTasksByPriority